...
//             //     Save("sample", ".png", 1920, 1080);
//             // }

//             #region DB
//             if(StaticCameraSchema.IsActive)
//             {

//                 getScreenshot(StaticCameraSchema.ScreenCaptureType, 1920,1080);
...
//         public void getScreenshot(int type, int width, int height)
//         {
//             var pass = capturePasses[type];
//             switch (type)
//             {  
//                 case 0:
...
//         public byte[] generateScreenshot(Camera cam, int width, int height, bool supportsAntialiasing, bool needsRescale)
//         {
//             var mainCamera = GetComponent<Camera>();
//             var depth = 24;
...
//             File.WriteAllBytes("Sunil.png", bytes);
//             return bytes;
