...
namespace Commons{
    public static class AirplaneProperties{
        ...
        public static void initAirplaneJsonObject(){
            ...
            CommonFunctions.airplanePreset["Cessna152/flapDragFactor"] = 0.0005;// Drag when flap is used
            ...
            //engine
            CommonFunctions.airplanePreset["Cessna152/maxRPM"] = 2700; // RPM for the 
            CommonFunctions.airplanePreset["Cessna152/shutOffSpeed"] = 2; // 
            CommonFunctions.airplanePreset["Cessna152/wingSpan"] = 1.6; //
            //fuel 
            ...
            //input
            CommonFunctions.airplanePreset["Cessna152/throttleSpeed"] = 0.2;//
            //wheel
            ...
            CommonFunctions.airplanePreset["F4UCorsair/wingSpan"] = 2.4; //
            //fuel 
